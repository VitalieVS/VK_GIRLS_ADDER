...
public class CreateList {
    ...
    private ArrayList<Long> createList(String data) {
        ...
        if (!data.isEmpty()) {
            ...
            for (int i = 0; i < keys.length(); i++) {
                JSONObject id = keys.getJSONObject(i);
                resultList.add(id.getLong("id"));
            }
        }
        return resultList;
    }

    private ArrayList<Long> checkList(ArrayList<Long> list) {
        ArrayList<Long> resultList = new ArrayList<>();
    ...
    private static String getData(String ACCESS_TOKEN) {
       ...
       // final String ACCESS_TOKEN = "5e54954f0482784f8299d866c2e1307e12a435afebe0f6a948314815491c71f9e38136b62438983c7a694";
        ...
        try {
            URL url = new URL("https://api.vk.com/method/users.search?count=150&city=953&country=15&age_from=14&age_to=21&sex=1&access_token=" + ACCESS_TOKEN + "&v=5.130");
